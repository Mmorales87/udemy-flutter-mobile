...
// * El dispose se llama cuando el widget esta marcado
// * para ser eliminado del arbol de widgets o ya esta destuido
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MediaQuery.removePadding(
        context: context,
        // * con el removePadding quitamos el padding de la
        // * parte superior e inferior del ListView
        removeTop: true,
        removeBottom: true,
